...
object UserMessages {
    ...
    const val BOOKINGS_CACHED = "No internet connection. Showing your stored bookings."
    ...
    const val BOOKING_SYNC_CONFLICT = "A pending booking could not be confirmed and was removed."
    const val BOOKING_CONFIRMED = "Booking confirmed successfully."
    const val BOOKING_DELETED = "Booking deleted successfully."
}
